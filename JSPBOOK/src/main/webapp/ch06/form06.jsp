...
<body>
	...
	<form action="form06_process.jsp" name="member" method="post">
		...
		<p>연락처 : <select name="phone1"> <!-- name 꼭 설정해야 함 -->
					<option value="010">010</option> <!-- value와 텍스트 내용은 일치하지 않아도 됨. 데이터는 value값이 넘어감 -->
		...
		<p>
			<textarea name="comment" cols="30" rows="3" placeholder="가입 인사를 입력해 주세요."></textarea>
		</p>
