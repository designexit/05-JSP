	...
	<%@ include file="dbconn.jsp" %>
		...
		<div class="container">
			<div class="row">
				...
				<!-- 상품 폼 -->
				<div class="col-md-7">
					<form action="./processUpdateProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
						<div class="form-group row">
							<label class="col-sm-2"><fmt:message key="productId"/></label><!-- 상품코드 -->
							<div class="col-sm-3">
